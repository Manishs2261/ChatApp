                ...
                case ConnectionState.done:
                  ...
                  if (_list.isNotEmpty) {
                    return ListView.builder(
                        itemCount:
                            _isSearching ? _isSerchList.length : _list.length,
              ...
              return ListTile(
                  ...
                  leading: InkWell(
                    onTap: () {
                      showDialog(
                          context: context,
                          builder: (_) => ImageDialog(userModel: widget.chat));
                    },
                    child: ClipRRect(
                  ...
                  trailing: _chatModel == null
                      ...
                      : _chatModel!.read!.isEmpty &&
                              _chatModel!.fromid != Apis.user.uid
                          ?
                          ...
                          : Text(
                              MyDataUtils.getLastMessageTime(
                                  context: context,
                                  time: _chatModel!.send.toString()),
